...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:/dev/gitstack/data/data.db',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = 'C:/dev/gitstack/app/app/staticfiles/'
...
SECRET_KEY = 'v6_#%r#$6%^^+h@0copel-)6sbf7*m%c_=@^3)5)s7e-qaeu!*'
